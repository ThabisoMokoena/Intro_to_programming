def three_nos_to_words(x)
    ...
    if length == 3
        ...
        tens_in_word.strip.empty? ? tens_in_word = tens_in_word : tens_in_word = " and " + tens_in_word 
...
def fiw(x)
    ...
    if length == 4
        ...
        thousand_text = three_nos_to_words(outer_array[2]) + " thousand"
        unit_text = three_nos_to_words(outer_array[3])
    elsif length == 3
        million_text = three_nos_to_words(outer_array[0]) + " million"
        thousand_text = three_nos_to_words(outer_array[1]) + " thousand"
